...
class Point(object):
    ...
    def move_to(self, x, y):
        self.distance_to = self.distance_to + math.sqrt((self.x - x) ** 2 + (self.y - y) ** 2)
        self.x = x
        self.y = y
    ...
    def move_by(self, dx, dy):
        ...
        self.count = self.count + 1
        self.distance_by = self.distance_by + math.sqrt(dx ** 2 + dy ** 2)
    ...
    def get_distance_from_start(self):
        ...
        d = math.sqrt((self.start_x - self.x) ** 2 + (self.start_y - self.y) ** 2)

        return d

    def get_distance_traveled(self):

        self.distance = self.distance_by + self.distance_to

        return self.distance

    def closer_to(self, p1, p2):

        if math.sqrt((self.x - p1.x) ** 2 + (self.y - p1.y) ** 2) > math.sqrt((self.x - p2.x) ** 2 + (self.y - p2.y) ** 2):
            return p2
        else:
            return p1
    ...
    def halfway_to(self, point):
        ...
        new_pointx = 0.5 * (self.x + point.x)
        new_pointy = 0.5 * (self.y + point.y)
...
def run_test_get_distance_traveled():
    ...
    """
    # --------------------------------------------------------------------------
    # : 11.  Follow the same instructions as in _TODO_ 3 above,
...
def run_test_closer_to():
    ...
    """
    # --------------------------------------------------------------------------
    # TDO: 12.  Follow the same instructions as in TO-DO 3 above,
...
def run_test_halfway_to():
    ...
    """
    # --------------------------------------------------------------------------
    # TDO: 13.  Follow the same instructions as in TO-DO 3 above,
